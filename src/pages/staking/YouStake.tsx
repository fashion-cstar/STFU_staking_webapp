        ...
        <div className='w-full'>
            <div className='w-full p-5'>
                <div className='flex flex-col gap-2 w-full mt-[12.5vh] md:mt-0'>
                    ...
                    {stakingVersion === 1 && <><div className='text-app-green text-[32px] text-center w-full'>${(Number(formatEther(totalStaked, 18, 2, false)) * price).toLocaleString()}</div>
                        <div className='text-app-purple text-[20px] text-center w-full uppercase'>{`(${formatEther(totalStaked, 18, 2, true)} STFU)`}</div>
                    </>}
                    {stakingVersion === 2 && <><div className='text-app-green text-[32px] text-center w-full'>${(Number(formatEther(totalStakedV2, 18, 2, false)) * price).toLocaleString()}</div>
                        <div className='text-app-purple text-[20px] text-center w-full uppercase'>{`(${formatEther(totalStakedV2, 18, 2, true)} STFU)`}</div>
                    </>}
                </div>
                <div className='flex flex-col gap-1 w-full mt-[30px]'>
                    ...
                    <div className='flex gap-1'>
                        ...
                        {stakingVersion === 1 && <div className='basis-1/2 text-app-green text-[20px] w-full uppercase'>{Number(apy).toLocaleString()}<span className='text-white text-[14px]'>{' '}%</span></div>}
                        {stakingVersion === 2 && <div className='basis-1/2 text-app-green text-[20px] w-full uppercase'>{Number(apyV2).toLocaleString()}<span className='text-white text-[14px]'>{' '}%</span></div>}
                    </div>
                    <div className='flex gap-1'>
                        <div className='basis-1/2 text-white text-[20px] w-full uppercase min-w-[170px]'>unclaimed</div>
                        {stakingVersion === 1 && <div className='basis-1/2 text-app-green text-[20px] w-full uppercase'>{`${formatEther(pendingReward, 18, 4, true).toLocaleString()}`}<span className='text-white text-[14px]'>{' '}STFU</span></div>}
                        {stakingVersion === 2 && <div className='basis-1/2 text-app-green text-[20px] w-full uppercase'>{`${formatEther(pendingRewardV2, 18, 4, true).toLocaleString()}`}<span className='text-white text-[14px]'>{' '}STFU</span></div>}
                    </div>
                    <div className='flex gap-1'>
                        <div className='basis-1/2 text-white text-[20px] w-full uppercase min-w-[170px]'>staked</div>
                        {stakingVersion === 1 && <div className='basis-1/2 text-app-green text-[20px] w-full uppercase'>{`${userInfo ? formatEther(userInfo.amount, 18, 2, true) : ''}`}<span className='text-white text-[14px]'>{' '}STFU</span></div>}
                        {stakingVersion === 2 && <div className='basis-1/2 text-app-green text-[20px] w-full uppercase'>{`${userInfoV2 ? formatEther(userInfoV2.amount, 18, 2, true) : ''}`}<span className='text-white text-[14px]'>{' '}STFU</span></div>}
                    </div>
                </div>
