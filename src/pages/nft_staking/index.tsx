            ...
            <div className="w-full relative pt-[53px]">
                ...
                <div className='w-full flex justify-center'>
                    <div className='max-w-[1440px] w-full px-6 md:px-8'>
                        <div className='w-full text-[25px] text-[#000] font-semibold my-6 md:my-8' style={{ fontFamily: 'Bebas' }}>Stake your 'Mad Scientist' NFTs to earn BNB for staking!</div>
                ...
                <div className={`fixed left-[0px] bottom-[0px] h-[50px] lg:h-[30px] bg-[#6FFF39] bg-center lg:bg-top bg-repeat-x bg-[url('./assets/nft_mobile_side.svg')] lg:bg-[url('./assets/nft_desktop_side.svg')]`} style={{ width: 'calc(100% + 190px)' }}>
                </div>
            </div>
        </div>
    )
